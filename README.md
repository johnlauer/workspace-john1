# com-chilipeppr-workspace-john1
A ChiliPeppr Workspace to show folks how to make their own.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / john1
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-john1 |
| Name                  | Workspace / john1 |
| Description           | A ChiliPeppr Workspace to show folks how to make their own. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/johnlauer/workspace-john1/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/johnlauer/workspace-john1 |
| Github URL            | http://github.com/johnlauer/workspace-john1 |
| Test URL              | https://preview.c9users.io/johnlauer/workspace-john1/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/johnlauer/workspace-john1/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-john1"], // the id you gave your workspace
      function(myWorkspaceJohn1) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / john1 just got loaded.", myWorkspaceJohn1);
        myWorkspaceJohn1.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-john1"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / john1"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace to show folks how to make their own."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/johnlauer/workspace-john1/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/johnlauer/workspace-john1"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/johnlauer/workspace-john1"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-john1-johnlauer.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
