...
cprequire_test(["inline:com-chilipeppr-workspace-john1"], function(ws) {
    ...
    $('title').html("john1 Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-john1", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-john1", // Make the id the same as the cpdefine id
        name: "Workspace / john1", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace to show folks how to make their own.`,
        ...
        /**
         * Load my current sensor widget
         */
        loadCurrentSensorWidget: function() {
            chilipeppr.load(
                "#net-mydomain-widget-currentsensor-instance",
                "http://raw.githubusercontent.com/johnlauer/widget-currentsensor/master/auto-generated-widget.html",
                function() {
                    // Callback after widget loaded into #myDivNetMydomainWidgetCurrentsensor
                    // Now use require.js to get reference to instantiated widget
                    cprequire(
                        ["inline:net-mydomain-widget-currentsensor"], // the id you gave your widget
                        function(myObjNetMydomainWidgetCurrentsensor) {
                            // Callback that is passed reference to the newly loaded widget
                            console.log("Widget / Current Sensor just got loaded.", myObjNetMydomainWidgetCurrentsensor);
                            myObjNetMydomainWidgetCurrentsensor.init();
                        }
                    );
                }
            );
